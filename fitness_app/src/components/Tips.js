        ...
        <Box sx={{display:"flex",flexDirection:"row",justifyContent:"center",gap:2}}>
          ...
          <Paper sx={{ p: 3}}>
              ...
              <TipsItem
                ...
                title2={"Benefits of drinking water | Student Health Tips | Education"}
                videoLink3={"https://www.youtube.com/embed/9iMGFqMmUFs"}
                title3={"What would happen if you didn’t drink water? - Mia Nacamulli"}
                imgAlt={"water"}
                />
          {goal==="GainMuscle"?
          <>
             <TipsItem
               labelTips={t('rythmn-advice')}
                ...
                title2={"a week of workouts, remember that every week is different"}
          ...
          <> 
             <TipsItem
                ...
                title3={"Best Workout Routine For Losing Weight, According To Exercise Experts"}
                imgAlt={"split"}
                />
