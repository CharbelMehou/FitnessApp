...
const Navbar = () => {
  ...
  return ( 
    <Box  sx={{ display :'flex',flexDirection:'row',gap: { sm: '123px', xs: '40px' }  }} >
      <Box sx={{ display :'flex',flexDirection:'row',justifyContent:'space-between',width:{xs:'50/%',lg:'100%'}}}>
              <Link to="/">
          ...
          <Box sx={{display:'flex',justifyContent:{xs:'flex-start',lg:'flex-end'},mt:2}}>
              <LangageSwitcher/>
          </Box>
      </Box>
  </Box>
